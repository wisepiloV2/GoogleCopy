...
const apps: AppItem[] = [
  { name: 'Maps', url: 'maps.google.com'},
  { name: 'YouTube', url: 'youtube.com'},
  { name: 'Gmail', url: 'gmail.com'},
  { name: 'Meet', url: 'meet.google.com'},
    ...
    return (
        <div className="apps-menu-container" ref={menuRef}>
            ...
            {isOpen && (
                ...
                {apps.map((app, index) => (
                    <a key={index} href={app.url} className="app-item">
                    <img
                    src={`https://www.google.com/s2/favicons?domain=${app.url}&sz=16`}
                    alt=""
                    className="app-icon"
                    />
